  ...
  return (
    <div>
      ...
      >
        ...
        <div className="absolute w-[256px] h-[31px] left-[-548px] top-[60px]">
          <h2
            className="font-bold text-3xl leading-[52px] text-red"
        ...
        <div
          className="absolute w-[472px] h-[31px] left-[-550px] top-[110px]"
          style={{ fontFamily: "Inika" }}
        >
          <h1 className="font-bold text-5xl leading-[65px] text-brown">
            Discover Serenity
          </h1>
          <h1 className="top-[158px] font-bold text-5xl text-brown">
            Through Pages
          </h1>
        </div>
        <div
